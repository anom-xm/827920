-- ================================================
--   Reaper Aim | by Zaxy.Hex
--   Universal FPS Script — WindUI
-- ================================================
...
CH_SGui.Name = "ReaperAim_CH"; CH_SGui.ResetOnSpawn = false
...
-- ==================== ABA HOME ====================
TabHome:Section({ Title = "Reaper Aim — Universal" })
...
-- ==================== ABA CONFIG — ENGINE ====================
local CONFIG_PATH = "ReaperAim/config.json"
...
local function SalvarConfig()
    local ok, err = pcall(function()
        if not isfolder("ReaperAim") then makefolder("ReaperAim") end
...
TabConfig:Toggle({
    ...
    Callback = function(v)
        ...
        pcall(function()
            if not isfolder("ReaperAim") then makefolder("ReaperAim") end
            writefile("ReaperAim/autoload.txt", v and "true" or "false")
        end)
...
TabCredits:Section({ Title = "Script feito por Zaxy.Hex  —  Reaper Aim", TextSize = 14, TextTransparency = 0.3 })
TabCredits:Space()
...
-- ==================== FINALIZACAO ====================
Notify("Reaper Aim", "Script carregado! by Zaxy.Hex", 5)
